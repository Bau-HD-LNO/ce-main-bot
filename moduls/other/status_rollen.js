...
module.exports = client => {
    let textInStats = config.Statusrollen.statustxt1
    let textInStats2 = config.Statusrollen.statustxt2
    let guildId = config.Statusrollen.guildid
    let roleId = config.Statusrollen.roleid
